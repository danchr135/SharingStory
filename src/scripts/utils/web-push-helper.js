...
class WebPushHelper {
  ...
  /**
   * Trigger push notification via backend (optional, jika backend mendukung)
   * @param {Object} payload
   */
  async triggerPushNotification(payload) {
    try {
      await storyRepository.triggerPushNotification(payload);
    } catch (error) {
